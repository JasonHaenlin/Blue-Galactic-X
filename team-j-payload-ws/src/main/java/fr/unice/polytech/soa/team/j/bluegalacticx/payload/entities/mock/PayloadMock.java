...
public class PayloadMock {
    ...
    static {
        ...
        payloads.add(new Payload(PayloadType.WARHEADS, "5", "1", PayloadStatus.WAITING_FOR_MISSION,
                new SpaceCoordinate(30, 10, 0), 500, "6c8c700c-1c01-4c72-b845-f251f01502e4", new Date()));
        payloads.add(new Payload(PayloadType.SATELLITE, "10", "2", PayloadStatus.WAITING_FOR_MISSION,
