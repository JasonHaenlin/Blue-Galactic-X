...
public class KafkaProducerConfig {
    ...
    @Bean
    public ProducerFactory<String, PayloadStatusRequest> producerPayloadStatusFactory() {
    ...
    @Bean
    public KafkaTemplate<String, PayloadStatusRequest> kafkaTemplate() {
        return new KafkaTemplate<>(producerPayloadStatusFactory());
    }
}
