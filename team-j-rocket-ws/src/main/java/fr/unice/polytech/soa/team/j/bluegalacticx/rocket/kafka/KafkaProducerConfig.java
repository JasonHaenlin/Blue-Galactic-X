...
public class KafkaProducerConfig {
    ...
    @Bean
    public ProducerFactory<String, Integer> producerMaxQFactory() {
        Map<String, Object> configProps = new HashMap<>();
        configProps.put(ProducerConfig.BOOTSTRAP_SERVERS_CONFIG, brokerHost + ":" + brokerPort);
        configProps.put(ProducerConfig.KEY_SERIALIZER_CLASS_CONFIG, StringSerializer.class);
    ...
    @Bean
    public KafkaTemplate<String, Integer> kafkaTemplateMaxQ() {
        return new KafkaTemplate<>(producerMaxQFactory());
    }
}
